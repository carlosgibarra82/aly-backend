package com.aycsolucionesenti.aly;
...
public class AlyApplication {
	...
	@Value("${com.aycsolucionesenti.aly.connectionTimeout}")
	public int connectionTimeout;

	@Value("${com.aycsolucionesenti.aly.readTimeout}")
	public int readTimeout;

	@Value("${com.aycsolucionesenti.aly.jwkUrl}")
